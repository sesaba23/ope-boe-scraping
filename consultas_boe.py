...
def opciones_filtros(ruta_bd="datos/boe.db"):
    ...
    try:
        resultado = {}
        for clave, columna in (("provincias", "provincia"), ("sistemas", "sistema"), ("turnos", "turno")):
