...
def seleccionar():
    ...
    try:
        ...
        fuente = INF / 'fase8_paso46_tecnicos_informaticos_detalle.csv'
        if fuente.exists():
        ...
        return [fila for fila in filas if PATRON.search(norm._clave(fila['puesto'])) and fila['puesto_normalizado'] == fila['puesto']]
    finally:
        conexion.close()
